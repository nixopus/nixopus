 ...
 */
import type { CreateDeploymentRequestBuildVariables } from './createDeploymentRequestBuildVariables';
import type { CreateDeploymentRequestEnvironmentVariables } from './createDeploymentRequestEnvironmentVariables';
...
export interface CreateDeploymentRequest {
  ...
  branch?: string;
  build_pack?: string;
  build_variables?: CreateDeploymentRequestBuildVariables;
  /** @nullable */
  dockerfile_path?: string | null;
  domain?: string;
  environment?: string;
  environment_variables?: CreateDeploymentRequestEnvironmentVariables;
  name?: string;
  port?: number;
