 ...
 */
import type { UpdateDeploymentRequestBuildVariables } from './updateDeploymentRequestBuildVariables';
import type { UpdateDeploymentRequestEnvironmentVariables } from './updateDeploymentRequestEnvironmentVariables';
import type { UpdateDeploymentRequestId } from './updateDeploymentRequestId';
...
export interface UpdateDeploymentRequest {
  ...
  /** @nullable */
  build_variables?: UpdateDeploymentRequestBuildVariables;
  /** @nullable */
  dockerfile_path?: string | null;
  /** @nullable */
  environment_variables?: UpdateDeploymentRequestEnvironmentVariables;
  /** @nullable */
  force?: boolean | null;
  /** @nullable */
  id?: UpdateDeploymentRequestId;
  /** @nullable */
  name?: string | null;
  /** @nullable */
  port?: number | null;
  /** @nullable */
  post_run_command?: string | null;
  /** @nullable */
