  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        'data-[active=true]:bg-sidebar-accent data-[active=true]:font-bold data-[active=true]:text-sidebar-accent-foreground data-[active=true]:[&>svg]:stroke-[3.5] data-[active=true]:[&>span]:scale-110 data-[active=true]:[&>span]:drop-shadow-sm',
        size === 'sm' && 'text-xs',
        size === 'md' && 'text-sm',
        'group-data-[collapsible=icon]:hidden',
        className
