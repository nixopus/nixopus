...
all_env_vars_set_successfully = "All environment variables set successfully for api and view services."
failed_to_set_env_vars = "Failed to set environment values for {API_SERVICE} and {VIEW_SERVICE}: {error}"
