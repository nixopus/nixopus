...
from app.utils.posthog import track_installation_failure, track_installation_success, track_staging_installation
...
def show_success_message(config_resolver: ConfigResolver, params: InstallParams) -> None:
    ...
    track_installation_success(staging=params.staging)
